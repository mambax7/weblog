...
if (!defined('WEBLOG_BLOCK_LINKS_INCLUDED')) {
    ...
    function b_weblog_links_edit($options)
    {
        ...
        $form .= sprintf('<tr><td><b>%s</b>:</td><td><input type="text" name="options[]" value="%d" size="2" maxlength="2"></td></tr>', _MB_WEBLOG_EDIT_LINKS_NUMBER, (int)$options[1]);
        $form .= sprintf('<tr><td><b>%s</b>:</td><td><input type="text" name="options[]" value="%d" size="2" maxlength="2" ></td></tr>', _MB_WEBLOG_EDIT_LINKS_ONLYPOST, (int)$options[2]);
        $form .= sprintf('<tr><td><b>%s</b>:</td><td><input type="text" name="options[]" value="%d" size="2" maxlength="2" ></td></tr>', _MB_WEBLOG_EDIT_LINKS_SHOWDSC, (int)$options[3]);
        $form .= '</table>';
