...
$modversion['release_date']        = '2017/02/02';
...
$modversion['tables'][0] = $moduleDirName;
$modversion['tables'][1] = $moduleDirName . '_category';
$modversion['tables'][2] = $moduleDirName . '_priv';
$modversion['tables'][3] = $moduleDirName . '_trackback';
$modversion['tables'][4] = $moduleDirName . 'myalbum_photos';
...
$modversion['helpsection'] = [
    ['name' => _MI_WEBLOG_OVERVIEW, 'link' => 'page=help'],
    ['name' => _MI_WEBLOG_DISCLAIMER, 'link' => 'page=disclaimer'],
    ['name' => _MI_WEBLOG_LICENSE, 'link' => 'page=license'],
    ['name' => _MI_WEBLOG_SUPPORT, 'link' => 'page=support'],
];
...
$modversion['config'][] = [
    ...
    'default'     => 1,
    'options'     => [
        '_MI_WEBLOG_UPDATE_READS_WHEN1' => 1,
...
$modversion['config'][] = [
    ...
    'description' => '_MI_WEBLOG_EDITOR_DESC',
    'formtype'    => 'select',
    'valuetype'   => 'text',
    'options'     => $editorList,
...
$modversion['config'][] = [
    ...
    'valuetype'   => 'text',
    'default'     => 'weblog',
    'options'     => ['weBLog simple system' => 'weblog', 'XOOPS standard system' => 'XOOPS']
];
...
$modversion['config'][] = [
    ...
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => '/uploads/' . $moduleDirName . '/thumbs',
    'options'     => []
];
$modversion['config'][] = [
...
$modversion['config'][] = [
    ...
    'default'     => 'w',
    'options'     => [
        '_MI_ALBUM_OPT_CALCFROMWIDTH'   => 'w',
        '_MI_ALBUM_OPT_CALCFROMHEIGHT'  => 'h',
        '_MI_ALBUM_OPT_CALCWHINSIDEBOX' => 'b'
    ]
];
...
$modversion['config'][] = [
    ...
    'default'     => 0,
    'options'     => [
        '_MI_WEBLOG_NO_CHECK_TRACKBACK'    => 0,
        '_MI_WEBLOG_TRACKBACK_NEEDLETTER1' => 1,
        '_MI_WEBLOG_TRACKBACK_NEEDLETTER2' => 2,
        '_MI_WEBLOG_TRACKBACK_NEEDLETTER3' => 3
    ]
];
$modversion['config'][] = [
    'name'        => 'spam_word',
...
// Templates
$modversion['templates'][1]['file']        = 'weblog' . $mydirnumber . '_entries.tpl';
$modversion['templates'][1]['description'] = _MI_WEBLOG_TEMPLATE_ENTRIESDSC;
$modversion['templates'][2]['file']        = 'weblog' . $mydirnumber . '_post.tpl';
$modversion['templates'][2]['description'] = _MI_WEBLOG_TEMPLATE_POSTDSC;
$modversion['templates'][3]['file']        = 'weblog' . $mydirnumber . '_details.tpl';
$modversion['templates'][3]['description'] = _MI_WEBLOG_TEMPLATE_DETAILSDSC;
$modversion['templates'][4]['file']        = 'weblog' . $mydirnumber . '_rss.tpl';
$modversion['templates'][4]['description'] = _MI_WEBLOG_TEMPLATE_RSSFEEDDSC;
$modversion['templates'][5]['file']        = 'weblog' . $mydirnumber . '_print.tpl';
$modversion['templates'][5]['description'] = _MI_WEBLOG_TEMPLATE_PRINTDSC;
$modversion['templates'][6]['file']        = 'weblog' . $mydirnumber . '_archive.tpl';
$modversion['templates'][6]['description'] = _MI_WEBLOG_TEMPLATE_ARCHIVEDSC;
$modversion['templates'][7]['file']        = 'weblog' . $mydirnumber . '_imagemanager.tpl';
$modversion['templates'][7]['description'] = _MI_WEBLOG_TEMPLATE_IMAGEMANAGERDSC;
//$modversion['templates'][8]['file'] = 'weblog'.$mydirnumber.'_calblock.css.tpl' ;
$modversion['templates'][8]['file']        = 'weblog_calblock.css.tpl';
...
$modversion['blocks'][1]['template']    = 'weblog' . $mydirnumber . '_block_recent.tpl';
$modversion['blocks'][1]['options']     = $moduleDirName . '|10|25|Y/m/d|1|1|1|0|0';
...
$modversion['blocks'][2]['template']    = 'weblog' . $mydirnumber . '_block_top_weblogs.tpl';
$modversion['blocks'][2]['options']     = $moduleDirName . '|10|1|1';
...
$modversion['blocks'][3]['template']    = 'weblog' . $mydirnumber . '_block_users_weblogs.tpl';
$modversion['blocks'][3]['options']     = $moduleDirName . '|5|5|Y/m/d|0|0|0|25|0|0';
...
$modversion['blocks'][4]['template']    = 'weblog' . $mydirnumber . '_block_recent_tb.tpl';
$modversion['blocks'][4]['options']     = $moduleDirName . '|5|25|Y/m/d|2';
...
$modversion['blocks'][5]['template']    = 'weblog' . $mydirnumber . '_block_recent_com.tpl';
$modversion['blocks'][5]['options']     = $moduleDirName . '|5|25|Y/m/d|2';
...
$modversion['blocks'][6]['template']    = 'weblog' . $mydirnumber . '_block_links.tpl';
$modversion['blocks'][6]['options']     = $moduleDirName . '||10|0|1';
...
$modversion['blocks'][7]['template']    = 'weblog' . $mydirnumber . '_block_recent_image.tpl';
$modversion['blocks'][7]['options']     = $moduleDirName . '|5|20|0|Y/m/d|0';
...
$modversion['blocks'][8]['template']    = 'weblog' . $mydirnumber . '_block_category_list.tpl';
$modversion['blocks'][8]['options']     = $moduleDirName . '|1';
...
$modversion['blocks'][9]['template']    = 'weblog' . $mydirnumber . '_block_archive.tpl';
$modversion['blocks'][9]['options']     = $moduleDirName . '|6';
...
$modversion['blocks'][10]['template']    = 'weblog' . $mydirnumber . '_block_calendar.tpl';
$modversion['blocks'][10]['options']     = $moduleDirName . '|';
...
$modversion['blocks'][11]['template'] = 'weblog'.$mydirnumber.'_block_latest_content.tpl';
$modversion['blocks'][11]['options'] = $moduleDirName .'|1|30|Y/m/d|0|1|0|1|60';
...
$modversion['blocks'][11]['template'] = 'weblog'.$mydirnumber.'_block_tbcenter.tpl';
$modversion['blocks'][11]['options'] = $moduleDirName .'|1';
*/
