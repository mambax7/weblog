...
function checkprivilege($type, $moduleDirName, $cat_id = 0)
{
...
{
    public function get_globalperm($moduleDirName)
    {
    ...
    // NOW nothing
    public function get_categoryperm($moduleDirName)
    {
        return 1;
    }
    ...
    /* ------------  READABLE PERMISSION  ----------- */
    // still nothing
    public function weblog_read_catperm($moduleDirName, $cat_id = 0)
    {
        return true;
    }

    public function can_read_index($moduleDirName, $cat_id = 0)
    {
        $global_perms = $this->get_globalperm($moduleDirName);
        if (($global_perms & WEBLOG_PERMIT_READINDEX) && $this->weblog_read_catperm($moduleDirName, $cat_id)) {
            return true;
        } else {
            return false;
        }
    ...
    public function can_read_detail($moduleDirName)
    {
        $global_perms = $this->get_globalperm($moduleDirName);
        if (($global_perms & WEBLOG_PERMIT_READDETAIL) && $this->weblog_read_catperm($moduleDirName)) {
            return true;
        } else {
            return false;
        }
    ...
    /* ------------  EDITABLE PERMISSION  ----------- */
    public function weblog_edit_gperm($moduleDirName)
    {
    ...
    // still nothing
    public function weblog_edit_catperm($moduleDirName, $cat_id = 0)
    {
        return true;
    }

    public function can_edit($moduleDirName, $cat_id = 0)
    {
        if ($this->weblog_edit_gperm($moduleDirName) && $this->weblog_edit_catperm($moduleDirName, $cat_id)) {
            return true;
        } else {
            return false;
        }
