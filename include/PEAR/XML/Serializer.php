...
class XML_Serializer extends PEAR
{
    ...
    public $_defaultOptions = array(
        ...
        // indent the attributes, if set to '_auto', it will indent attributes so they all start at the same column
        'mode'               => 'default',
        // use 'simplexml' to use parent name as tagname if transforming an indexed array
        'addDoctype'         => false,
        // add a doctype declaration
        'doctype'            => null,
        // supply a string or an array with id and uri ({@see XML_Util::getDoctypeDeclaration()}
        'rootName'           => null,
     ...
     * @return string
     */
    public function _serializeValue($value, $tagName = null, $attributes = array())
    {
        if (is_array($value)) {
     ...
     */
    public function _serializeArray(&$array, $tagName = null, $attributes = array())
    {
        $_content = null;
     ...
     * @return string $string serialized data
     */
    public function _serializeObject($object, $tagName = null, $attributes = array())
    {
