...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('WEBLOG_MB_LOADED')) {
    ...
    define('_MB_WEBLOG_LANG_SUNDAY', 'Sun');
    define('_MB_WEBLOG_LANG_MONDAY', 'Mon');
    define('_MB_WEBLOG_LANG_TUESDAY', 'Tue');
    define('_MB_WEBLOG_LANG_WEDNESDAY', 'Wed');
    define('_MB_WEBLOG_LANG_THURSDAY', 'Thu');
    define('_MB_WEBLOG_LANG_FRIDAY', 'Fri');
    define('_MB_WEBLOG_LANG_SATURDAY', 'Sat');
