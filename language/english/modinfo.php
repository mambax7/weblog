...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('WEBLOG_MI_LOADED')) {
    ...
    define('_MI_WEBLOG_PRIVMANAGER', 'Permissions (simple)');
    define('_MI_WEBLOG_MYGROUPSADMIN', 'Permissions (XOOPS)');
    ...
    define('_MI_WEBLOG_USEIMAGEMANAGERDSC', 'You can use weBLog image manager different with XOOPS core image manager. It can create thumbnail view.');
    ...
    define('_MI_WEBLOG_PRIVILEGE_SYSTEM', 'Permissions System');
    ...
    define('_MI_ALBUM_OPT_CALCWHINSIDEBOX', 'Put in specified size square');
