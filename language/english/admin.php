...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('WEBLOG_AM_LOADED')) {
    ...
    define('_AM_WEBLOG_PRIVMANAGER_WEBLOG', 'Permissions (weBLog simple system)');
    ...
    define('_AM_WEBLOG_PRIVMANAGER_XOOPS', 'Permissions (XOOPS standard system)');
    ...
    define('_AM_WEBLOG_NONPRIV', 'No Permission');
    define('_AM_WEBLOG_PRIV', 'Permission OK');

    define('_AM_WEBLOG_GROUPPERM_GLOBAL', 'Permission manager for each groups');
    define('_AM_WEBLOG_GROUPPERM_GLOBALDESC', 'Permission Settings to every group. EDIT Permissions to Anonymous user is invalid.');
    ...
    define('_AM_WEBLOG_UPGRADEFAILED0', "Update failed - couldn't rename field '%s'");
    define('_AM_WEBLOG_UPGRADEFAILED1', "Update failed - couldn't add new fields");
    define('_AM_WEBLOG_UPGRADEFAILED2', "Update failed - couldn't rename table '%s'");
    define('_AM_WEBLOG_ERROR_COLUMN', 'Could not create column in database : %s');
    define('_AM_WEBLOG_ERROR_BAD_XOOPS', 'This module requires XOOPS %s+ (%s installed)');
    define('_AM_WEBLOG_ERROR_BAD_PHP', 'This module requires PHP version %s+ (%s installed)');
    define('_AM_WEBLOG_ERROR_TAG_REMOVAL', 'Could not remove tags from Tag Module');
}
